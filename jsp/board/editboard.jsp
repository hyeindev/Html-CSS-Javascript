...
<!-- 수정 또는 삭제를 위한 게시 id 르 hidden 으로 전송 -->
...
<tr><td colspan=2>
	...
	<tr><td colspan="2">
				<textarea name="content" cols="90" rows="10"><%=content %></textarea></td></tr>
	...
	<tr>
		<td colspan="2">
			...
			<% } else { %>
						<!-- 버튼을 누르면 boardform.js 의 각 함수를 실행하여 processboard.jsp -->			
						<input type="button" value="수정완료" onClick="updatecheck()" />
						<input type="button" value="삭제" onClick="deletecheck()" />
			<% } %>
			
						<!-- 목록보기 버튼은 listboard.jsp 로 이동 -->
