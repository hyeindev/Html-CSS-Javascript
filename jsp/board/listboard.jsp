...
<hr>
	...
	<jsp:useBean id="brddb" class="boardbean.BoardDBCP" scope="page"></jsp:useBean>
...
<p>조회된 게시판 목록 수가 <%=counter %> 건 입니다.
<hr size="5" color="pink">
<form action="editboard.jsp" method="post" name="form">
